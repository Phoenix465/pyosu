from osureader.objects import General, Events, MetaData, Editor, Difficulty, HitCircle, TimingPoint, HitObject, TimingObject, SliderCircle
...
class Beatmap():
    ...
    def __init__(self, beatmap: dict):
        try:
            ...
            self.events_settings = Events(**beatmap['Events'])
